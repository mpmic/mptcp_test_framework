...
try:
    ...
    def jitclass(*args, **kwargs):
        ...
        def wrap_class(wrapped):
            ...
            # RuntimeError.
            Wrp = type(wrapped.__name__, wrapped.__bases__, dict(wrapped.__dict__))
            Wrp.__init__ = functools.update_wrapper(raise_error, wrapped.__init__)
            return Wrp
